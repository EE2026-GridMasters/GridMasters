...
def convert_image():
    ...
    # source_dir = 'frames'
    input_dir = 'Wait_Input'  # Name of directory where input pixel art images are stored, labelled 0000, 0001, etc
    bitmap_dir = 'P2P_Bitmap' # Bad Apple Bitmapping Only
    output_dir = 'Wait_Output'  # Name of directory where output .p2p files will be saved
...
def generate_code(input_folder, output_file):
    with open(output_file, 'w') as outfile:
        start_frame = 6301
        for i in range(start_frame, start_frame + 180):  # Replace ??? with the number of frames you want to convert
